...
name: pr
description: >
  Ship the current branch: lint → confirm commit → push → open PR. Run after a
  code-reviewer or code-guardian pass says the branch is ready. Do NOT run on main directly.
---

# PR — Ship the Current Branch

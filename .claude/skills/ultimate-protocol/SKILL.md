...
1. Write the code using your file tools.
2. Run the project's test or build command via the terminal tool to verify it.
3. If it fails, fix the code internally without asking the user.
4. Only when the verification command passes are you allowed to end your turn and output the JSON status block above.

...
- **Action Flow:**
  ...
  5. **Verification Phase:** Before claiming completion, run the required build/test terminal command to ensure your changes didn't break compilation.
...
- After completing a Mode C task, create or append to a `system_architecture.md` or `.cursorrules` file detailing the design pattern you just used.
